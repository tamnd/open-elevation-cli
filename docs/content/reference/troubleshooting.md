...
Most of these come down to network reality or how open-elevation serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

open-elevation rate-limits like any public site. open-elevation already paces
...
Where a surface is gated, open-elevation reads a cookie or token you supply
...
`open-elevation`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what open-elevation actually did
