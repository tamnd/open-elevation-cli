...
```
open-elevation <command> [arguments] [flags]
```

Run `open-elevation <command> --help` for the full flag list on any command. This
...
per operation you declare in `open-elevation/domain.go`.
